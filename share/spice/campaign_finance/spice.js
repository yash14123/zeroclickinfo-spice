...
function ddg_spice_campaign_finance(candidate) {
    var snippet = '';
...
function format_snippet(candidate){
    ...
    div.innerHTML += '<br>Top industries: <br>' + nrj("http://transparencydata.com/api/1.0/aggregates/pol/f99f7d244bbf4325b31312f75643f8da/contributors/sectors.json?apikey=81ae602f16f34cbc9fe2643c7691f3d3&callback=ddg_spice_campaign_finance_industry");
